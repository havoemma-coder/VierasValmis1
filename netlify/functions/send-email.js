...
export default async function handler(request, response) {
    ...
    try {
        // Netlify saattaa välittää datan merkkijonona, joten yritetään jäsentää se.
        const data = typeof request.body === 'string' ? JSON.parse(request.body) : request.body;

        // Lisätään lokitus nähdäksemme, mitä dataa saamme
        console.log('Received data:', data);

        // Varmistetaan, että paketti ja neliöt ovat olemassa ennen laskentaa
